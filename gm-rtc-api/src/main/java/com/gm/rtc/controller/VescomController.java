...
import com.gm.rtc.serviceImpl.VescomServiceImpl;
...
public class VescomController {
	...
	@Autowired
	VescomServiceImpl vescomService; 
	
	
	@ApiOperation(value = "Return all Items available in the System", response = Vescom.class)
	@ApiResponses(value = {
	...
	@PostMapping
	public ResponseEntity<Vescom> save(@RequestBody Vescom vescomRequest){
		Vescom save = vescomService.save(vescomRequest);
		return new ResponseEntity<Vescom>(save, HttpStatus.OK);
	}
	...
	@PatchMapping
	public ResponseEntity<Vescom> edit(@RequestBody Vescom vescomRequest){
		Vescom save = vescomService.save(vescomRequest);
		return new ResponseEntity<Vescom>(save, HttpStatus.OK);
	}
	...
	@GetMapping(value = "/{id}")
	public ResponseEntity<Vescom> get(@PathVariable String id){
		Vescom vescom = vescomService.get(id);
	...
	public ResponseEntity<List<Vescom>> fetchAll(){
		List<Vescom> vescom = vescomService.findAll();
